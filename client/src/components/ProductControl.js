...
class ProductControl extends Component {
    API_URL = process.env.BACKEND_APP_API_URL || 'http://localhost:4000';
    ...
    componentDidMount(){
        axios.get(`${this.API_URL}/api/products`)
            .then(res =>{
                console.log(res)
                this.setState({
    ...
    handleAddingNewProduct = (newProduct) =>{
        ...
        // }       
        // console.log(...formData)
        axios.post(`${this.API_URL}/api/products`, newProduct)
    ...
    handleEditingProduct = (editedProduct) =>{
        ...
        axios.put(`${this.API_URL}/api/products` + this.state.selectedProduct._id, editedProduct)
            .then(res =>console.log(res.data))
